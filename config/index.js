export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx4f2bfe4753da0ed9",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "f88197e4b5bf4536eb47f9b36b08f680",
  ...
  USERS: [
    ...
    {
      name: "老婆1",
      id: "o-OYE5wP7MLadlCdUGDbRYmwuiK0",
      useTemplateId: "TkY_EoMm_fb5_FtOdqRlQ_cm7eyA1ntbc5nyGnVikp8",
      province: "山东",
      city: "青岛",
      horoscopeDate: '',
      horoscopeDateType: '',
